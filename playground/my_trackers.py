...
class STrack(BaseTrack):
    ...
    # def activate(self, kalman_filter, frame_id):  # FIXME
    ...
    def activate(self, tracker, kalman_filter, frame_id):
        """Start a new tracklet."""
        self.kalman_filter = kalman_filter
        self.track_id = self.next_id(tracker)
        self.mean, self.covariance = self.kalman_filter.initiate(self.convert_coords(self._tlwh))
    ...
    # def re_activate(self, new_track, frame_id, new_id=False):  # FIXME
    ...
    def re_activate(self, tracker, new_track, frame_id, new_id=False):
        """Reactivates a previously lost track with a new detection."""
        self.mean, self.covariance = self.kalman_filter.update(self.mean, self.covariance,
                                                               self.convert_coords(new_track.tlwh))
        self.tracklet_len = 0
...
class BOTrack(STrack):
    ...
    def re_activate(self, tracker, new_track, frame_id, new_id=False):
        ...
        if new_track.curr_feat is not None:
            self.update_features(new_track.curr_feat)
        super().re_activate(tracker, new_track, frame_id, new_id)
...
class BYTETracker:
    ...
    def __init__(self, args, frame_rate=30):
        ...
        self._count = 0  # NOTE: Global track ID
    ...
    def update(self, results, img=None):
        ...
        for itracked, idet in matches:
            ...
            if track.state == TrackState.Tracked:
                ...
                # track.re_activate(det, self.frame_id, new_id=False)  # FIXME
                track.re_activate(self, det, self.frame_id, new_id=False)
        ...
        for inew in u_detection:
            ...
            if track.score < self.args.new_track_thresh:
                continue
            track.activate(self, self.kalman_filter, self.frame_id)
            activated_stracks.append(track)
        # Step 5: Update state
    ...
    # def reset_id(self):  # FIXME
    #     """Resets the ID counter of STrack."""
    #     STrack.reset_id()

    def reset_id(self):
        """Resets the ID counter of Tracker."""
        self._count = 0
